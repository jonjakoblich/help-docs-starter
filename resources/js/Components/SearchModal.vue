<template>
    <div class="fixed inset-0 z-50 mx-auto" @click="(e) => maybeCloseModal(e)" aria-modal="true">
        ...
        <div class="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
            <div id="searchModal" class="flex flex-col p-3 mx-auto transform-gpu overflow-hidden rounded-xl bg-white shadow-xl sm:max-w-xl">
                <div class="flex place-items-center gap-1">
                    <svg aria-hidden="true" viewBox="0 0 20 20" class="pointer-events-none h-full w-5 fill-gray-400">
